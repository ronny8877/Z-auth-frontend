...
export default function Footer() {
	...
	return (
		<footer className=" sticky  dark:bg-dark-800 dark:text-white min-h-80  w-full overflow-hidden text-left sm:text-center bg-gray-50 shadow-inner mt-10 p-2 md:p-5">
			...
			<div className=" flex flex-col md:flex-row w-80 text-xs sm:text-sm  gap-5  text-center m-auto mt-5 ">
                ...
                <button className="cursor-pointer" onClick={handelBecomeDev}>Develope with Us</button>
				
			</div>

			<div className="flex flex-col sm:px-7 m-auto gap-1   flex-wrap">
			<h1 className="text-center text-2xl dark:text-white font-montserrat">Z-auth</h1>
